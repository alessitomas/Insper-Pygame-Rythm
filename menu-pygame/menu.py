...
def inicializa():
    ...
    state = {
         "cor": [VERMELHO,VERMELHO,VERMELHO,VERMELHO,VERMELHO], 
...
def desenha(window: pygame.Surface, assets, state):
    ...
    text_surface = my_font.render("EXTRAS", False, (0, 0, 0))
    ...
    text_surface = my_font.render("HOW TO PLAY", False, (0, 0, 0))
    ...
    text_surface = my_font.render("OPTIONS", False, (0, 0, 0))
    ...
    text_surface = my_font.render("CREDITS", False, (0, 0, 0))
